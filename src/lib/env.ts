...
const serverSchema = z.object({
  ...
  DISCOVERY_SCHEDULER_ENABLED: featureFlagSchema,
  DISCOVERY_DRY_RUN_ONLY: featureFlagSchema,
  DISCOVERY_SCHEDULER_SECRET: z.string().min(32).optional(),
  CRON_SECRET: z.string().min(32).optional(),
  DISCOVERY_ORCHESTRATOR_URL: z.string().url().optional().or(z.literal("")),
  EDITORIAL_DIGEST_EMAIL_ENABLED: featureFlagSchema,
  NOTIFICATION_EMAIL_ENABLED: featureFlagSchema,
  GITHUB_PUBLICATION_ENABLED: featureFlagSchema,
...
export function getServerEnvironment() {
  return serverSchema.parse({
    ...
    DISCOVERY_SCHEDULER_ENABLED: process.env.DISCOVERY_SCHEDULER_ENABLED,
    DISCOVERY_DRY_RUN_ONLY: process.env.DISCOVERY_DRY_RUN_ONLY,
    DISCOVERY_SCHEDULER_SECRET: process.env.DISCOVERY_SCHEDULER_SECRET,
    CRON_SECRET: process.env.CRON_SECRET,
    DISCOVERY_ORCHESTRATOR_URL: process.env.DISCOVERY_ORCHESTRATOR_URL,
    EDITORIAL_DIGEST_EMAIL_ENABLED: process.env.EDITORIAL_DIGEST_EMAIL_ENABLED,
    NOTIFICATION_EMAIL_ENABLED: process.env.NOTIFICATION_EMAIL_ENABLED,
    GITHUB_PUBLICATION_ENABLED: process.env.GITHUB_PUBLICATION_ENABLED,
