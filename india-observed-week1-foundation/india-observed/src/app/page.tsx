  ...
  return (
    <main>
      <header className="site-header">
        <Link className="wordmark" href="/">India Observed</Link>
      ...
      <section className="hero" id="about">
        ...
        <div className="hero-actions">
          <a className="button primary" href="#status">View the pilot status</a>
          <a className="button secondary" href="#principles">Read the core principles</a>
        </div>
      </section>

      <section className="scope-note" aria-label="Scope note">
        <strong>Curated coverage:</strong> the pilot does not claim to capture every event in
        India. A missing state or district should never be interpreted as having no civic activity.
      </section>
      ...
      <section className="status-panel" id="status">
        ...
        <dl>
          <div><dt>Reviewed event records</dt><dd>11</dd></div>
          <div><dt>States / UTs represented</dt><dd>10</dd></div>
          <div><dt>Publication control</dt><dd>Human approval</dd></div>
        </dl>
      </section>
